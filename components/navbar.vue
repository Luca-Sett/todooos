    ...
    <Transition name="drop">
      ...
      >
        <div class="flex flex-col place-items-center text-heading">
          ...
          <LLink @click="close" to="/">home</LLink>
          <LLink @click="close" to="/plans">plans</LLink>
          <LLink @click="close" to="/login">login</LLink>
          <LLink @click="close" to="/register">register</LLink>
        </div>
      </div>
    </Transition>
  </Teleport>
